...
export default function AboutBody() {
  const values = [
    {
      ...
      title: 'Honor',
      description:
        'We honor the service and sacrifice of every veteran, ensuring our platform reflects the respect they deserve.',
    ...
    },
    {
      ...
      description:
        'Every feature is designed with clear purpose: helping veterans achieve successful civilian transitions.',
    ...
    },
    {
      ...
      title: 'Veteran-First',
      description:
        "Built by veterans, for veterans. We understand the unique challenges because we've lived them.",
    ...
    },
    {
      ...
      title: 'Community',
      description:
        'Fostering connections and mutual support among veterans navigating similar life transitions.',
  ...
  const leadership = [
    ...
    },
    {
      ...
      role: 'Veteran Services Advisor | Retired U.S. Army Senior NCO',
      branch: '',
      bio: 'After 24 years of military service, multiple deployments, and assignments around the world, Cleveland believed he was prepared for civilian life. His transition, however, revealed how difficult navigating that change can be. Drawing on decades of experience mentoring and supporting soldiers through life challenges, Cleveland now helps guide the development of resources that empower veterans to successfully navigate their transition to civilian careers and communities.',
      image: '/file_00000000ac6471fdbe4431c46e068293_(1).png',
    },
  ];
  ...
  return (
    <>
      <section className="py-20 bg-[var(--sandstone-beige)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl leading-relaxed" style={{ color: 'var(--deep-army-green)' }}>
            NextMission Navigator was founded by veterans who understand that the transition from military to
            civilian life requires more than just job placement—it demands comprehensive support, personalized
            guidance, and a community that truly understands the journey.
          </p>
        </div>
      </section>
            ...
            {militaryBranches.map((branch, index) => {
              ...
              return (
                <div key={index} className={`${branch.color} rounded-xl p-4 text-center card-hover`}>
                  ...
                  <h3 className="text-sm font-bold text-white mb-1">{branch.name}</h3>
                  <p className="text-xs text-white/80">{branch.description}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="pt-16 pb-8 bg-[var(--olive-drab)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Why We Exist</h2>
            ...
            {values.map((value, index) => {
              ...
              return (
                <div key={index} className={`${value.bgColor} rounded-xl p-6 text-center`}>
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 ${value.iconBg} rounded-full mb-6`}
                  >
      ...
      <section className="py-20 gradient-charcoal">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Leadership Team</h2>
            <p className="text-xl text-white/90">Founded and led by veterans who understand your journey.</p>
          </div>
            ...
            {leadership.map((leader, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-8">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="font-semibold mb-1 text-white">{leader.role}</p>
      ...
      <section className="py-16 text-white" style={{ backgroundColor: '#B8A572' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Navigate Your Next Mission?</h2>
          ...
          <div className="flex justify-center">
            <Link
              ...
              className="bg-[var(--military-green)] hover:bg-[var(--olive-drab)] text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200"
            >
              Start Your Journey
            </Link>
          </div>
