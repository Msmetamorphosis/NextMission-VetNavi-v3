...
export default function ContactBody() {
  const contactMethods = [
    ...
    },
    {
      icon: MessageCircle,
      title: 'AI chat',
      description: 'Chat with our AI assistant from the widget on this site.',
  ...
  return (
    <>
      <section className="py-20 bg-[var(--sandstone-beige)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl leading-relaxed" style={{ color: 'var(--deep-army-green)' }}>
            Our veteran support team is ready to assist you with any questions about your transition, our platform,
            or connecting you with the right resources.
          </p>
        </div>
      </section>
            ...
            {contactMethods.map((method, index) => {
              ...
              return (
                <div key={index} className={`${method.bgColor} rounded-xl p-8 text-center card-hover`}>
                  ...
                  <p className="font-semibold mb-2 text-white">{method.contact}</p>
      ...
      <section className="py-20 bg-[var(--pale-olive)] relative z-10">
